...
def save_feature_picture(data, name, image_name=None, padsize = 1, padval = 1):
    ...
    #plt.show()
    if image_name == None:
        img_path = '/home/ubuntu/user_space/maga_faster/our_method/feature/' 
    else:
        img_path = '/home/ubuntu/user_space/maga_faster/our_method/feature/' + image_name + "/"
        check_file(img_path)
    #plt.savefig(img_path + name + ".jpg", dpi = 400, bbox_inches = "tight")
    plt.savefig(img_path + name + ".jpg")
def check_file(path):
...
if __name__ == '__main__':
    ...
    for im_name in im_names:
        ...
        plt.savefig(im_name[:-4] + 'new_test86.jpg')
